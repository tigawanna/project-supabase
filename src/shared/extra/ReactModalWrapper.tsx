...
const customStyles: ModalStyles = {
        ...
        content: {
            position: 'absolute',
            top: styles?.content_top??adjustSize(isMobile,'1%','0%'),
            left: styles?.content_left ?? adjustSize(isMobile, '15%', '0%'),
            right: styles?.content_right ?? adjustSize(isMobile, '15%', '0%'),
            bottom: styles?.content_bottom ?? adjustSize(isMobile, '5%', '10%'),
            overflow: 'auto',
